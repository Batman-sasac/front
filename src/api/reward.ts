...
export async function checkAttendanceReward(): Promise<AttendanceRewardResponse> {
    ...
    const response = await fetchWithTimeout(`${API_BASE_URL}/reward/attendance`, {
        method: 'POST',
        headers: {
...
export async function claimRandomEventReward(): Promise<RandomEventRewardResponse> {
    ...
    const response = await fetchWithTimeout(`${API_BASE_URL}/reward/random-event`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token || ''}`,
...
export async function getRewardLeaderboard(): Promise<{
    ...
    const response = await fetchWithTimeout(`${API_BASE_URL}/reward/leaderboard`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token || ''}`,
...
export async function getMyRewardRank(): Promise<MyRewardRankResponse> {
    ...
    const response = await fetchWithTimeout(`${API_BASE_URL}/reward/my-rank`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token || ''}`,
