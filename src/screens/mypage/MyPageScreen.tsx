...
export default function MyPageScreen({
  ...
  const tryDisconnect = async (provider: "kakao" | "naver") => {
    ...
    try {
      ...
      Alert.alert(
        "성공",
        `${provider === "kakao" ? "카카오" : "네이버"} 계정 연동을 해제했습니다.`,
      );
    } catch (error: any) {
        ...
        <View style={styles.accountSection}>
          ...
          <View
            style={[
              ...
              kakaoConnected && styles.accountContainerConnected,
            ]}
          >
          ...
          <View
            style={[
              styles.accountContainer,
              naverConnected && styles.accountContainerConnectedNaver,
              { display: "none" },
            ]}
          >
              ...
              <View style={styles.accountRow}>
                <View style={styles.providerInfo}>
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={[styles.providerName, styles.naverText]}>
                    네이버 계정
                  </Text>
                </View>
                ...
                {naverConnected ? (
                  ...
                  >
                    <Text style={[styles.accountActionText, styles.naverText]}>
                      연동 해제
                    </Text>
                    <Image
                      source={require("../../../assets/shift.png")}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            <Text style={styles.modalMessage}>
              연결된 계정이 1개일 때는 해제할 수 없습니다.
            </Text>
            <Text style={styles.modalMessage}>
              다른 계정을 먼저 연동한 뒤 해제해주세요.
            </Text>
