...
export const questions: Question[] = [
    ...
    {
        id: 17,
        text: '시험 중에 시간이 부족할 때 어떻게 하나요?',
        aText: '정확도를 위해 하나씩 확인',
        bText: '일단 모든 문제에 답을 채워두는 게 중요',
        a: { tempo: 1 },
        b: { tempo: -1 },
    },
    {
        id: 18,
        text: '실수를 했을 때, 어떤 생각이 먼저 드나요?',
        aText: '틀린 이유 심도깊게 분석',
        bText: '가볍게 생각하고 넘김',
        a: { tempo: 1 },
        b: { tempo: -1 },
    ...
    {
        id: 19,
        text: '학습 후 복습할 때 어떤 편인가요?',
        aText: '요약 정리를 통해 내용 점검',
        bText: '느낌으로 전체적으로 기억',
        a: { tempo: 1 },
        b: { tempo: -1 },
    },
    {
        id: 20,
        text: '피드백을 받았을 때 어떻게 하나요?',
        aText: '받은 피드백은 점검하며 정리하여 적용',
        bText: '다음 문제나 과제에 빨리 적용하고 싶음',
        a: { tempo: 1 },
        b: { tempo: -1 },
    },
];
